...
```{r viz-score}
boxplot(evals$score, horizontal=TRUE, main="Distribution of Scores")

```

The data is skewed to the right, this means that the students are relatively happy with the courses. The whiskers are quite wide indicating there is a wide range of responses as well as three outliers on the left.
### Exercise 2
